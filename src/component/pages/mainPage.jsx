...
export default function MainPage() {
    ...
    const call = async () => {
        const dataBirthday = await getBirthday();
        const dataEmployees = await getEmployees();
        setEmployeesCount(dataEmployees.length);
        dataBirthday.length ? setInfo(dataBirthday) : setBirth(prev => !prev);
    }
        ...
        <div className={'page'}>
            ...
            <div className="container mx-auto mt-5">
                <div className="row text-center">
                    <h3>У нас працює <span className="badge badge-primary text-wrap">{employeesCount}</span> співробітників.
            ...
            <div className="container mx-auto mt-5">
                <div className="row text-center">
                    <h3>Вже створенно <span className="badge badge-primary text-wrap">{0}</span> розсилок.
